...
extern inline enum LogLevelFlags logger_set_level (enum LogLevelFlags lvl);
extern inline bool logger_would_log (enum LogLevelFlags lvl);


enum LogLevelFlags logger_level = LOG_LEVEL_MESSAGE;
